...
export const APIKEY_PROVIDERS = {
  ...
  "qoder-api": { id: "qoder-api", alias: "qda", name: "Qoder API", icon: FREE_PROVIDERS.qoder.icon, color: FREE_PROVIDERS.qoder.color, textIcon: "QA", website: "https://qoder.com", notice: { text: "This provider uses a Personal Access Token. Account may be restricted or banned. Use at your own risk.", apiKeyUrl: "https://qoder.com/account/integrations" } },
