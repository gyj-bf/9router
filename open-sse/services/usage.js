...
import { getCodebuddyCnApiUsage } from "./usage/codebuddy-cn-api.js";
import {
  getQwenUsage,
  getIflowUsage,
  getOllamaUsage,
...
const USAGE_HANDLERS = {
  ...
  "codebuddy-cn-api": (c) => getCodebuddyCnApiUsage({ apiKey: c.apiKey, accessToken: c.accessToken }, c.proxyOptions),
};
